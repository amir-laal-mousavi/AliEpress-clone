    ...
    <div class="max-w-[1200px] mx-auto px-4">
      <div class="md:flex gap-4 justify-between w-full">
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">Help Center, Disputes & Reports, Buyer Protection, Report IPR </div>
        </div>
        <div class="md:w-[50%] pt-4">
      ...
      <div class="md:flex gap-4 justify-between w-full">
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">All Popular, Product, Promotion, Low Price, Great Value, Reviews, Blog, Seller Portal, BLACK FRIDAY, AliExpress</div>
        </div>
        <div class="md:w-[50%] pt-4">
          <div class="text-lg font-semibold text-[#282828]">Alibaba Group</div>
          <div class="text-[#999999] text-sm">Alibaba Group Website, AliExpress, Alimama, Airplay, Fliggy, Alibaba Cloud, Alibaba International, AliTelecom</div>
        </div>
      </div>
    </div>
  </div>  
