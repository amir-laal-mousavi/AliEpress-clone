    ...
    <NuxtLink :to="`item/${product.id}`">
      ...
      <div class="ProductDetails">
        <span class="flex items-center justify-start gap-3 px-1 pt-1">
          ...
          <span class="text-gary-500 text-sm text-light line-through">${{ oldPriceComputed }}</span>
        </span>

        <span class="px-1 realtive -top-1.5 text-[#FF6674] text-xs font-semibold">
          Extra 5% off
        </span>
        ...
        <p class="px-1 pb-1">
          <spn class="text-[#009a66] text-xs font-semibold">Free Shipping</spn>
        </p>
      </div>
    </NuxtLink>
  </div>  
